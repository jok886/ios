...
@implementation XMGPlayerView

+ (instancetype)playerView
{
    return [[[NSBundle mainBundle] loadNibNamed:@"XMGPlayerView" owner:nil options:nil] firstObject];
}
- (void)awakeFromNib
{
    ...
    [self.progressSlider setThumbImage:[UIImage imageNamed:@"XMGPlayer.bundle/thumbImage"] forState:UIControlStateNormal];
    [self.progressSlider setMaximumTrackImage:[UIImage imageNamed:@"XMGPlayer.bundle/MaximumTrackImage"] forState:UIControlStateNormal];
    [self.progressSlider setMinimumTrackImage:[UIImage imageNamed:@"XMGPlayer.bundle/MinimumTrackImage"] forState:UIControlStateNormal];
